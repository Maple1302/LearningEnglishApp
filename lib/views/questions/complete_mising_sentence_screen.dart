...
class CompletedMissingSentenceScreen extends StatefulWidget {
  ...
  const CompletedMissingSentenceScreen(
      {super.key,
  ...
  @override
  State<CompletedMissingSentenceScreen> createState() =>
      _CompletedMissingSentenceScreenState();
}

class _CompletedMissingSentenceScreenState
    extends State<CompletedMissingSentenceScreen> {
